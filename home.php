                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.php"> <img src="img/LogoJuego.png" width="200px" height="150px" alt="logo"> </a>
                            ...
                            <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="contact.php">Sobre nosotros</a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="blog.html"> Iniciar Sesión</a>
                                            <a class="dropdown-item" href="single-blog.html">Registrarse</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="gallery_part_item">
                            <div class="grid">
                                ...
                                <a href="img/enemigo2.png" class="grid-item bg_img img-gal" style="background-image: url('img/enemigo2.png')">
                                    <div class="single_gallery_item">
                                        <div class="single_gallery_item_iner">
                                            <div class="gallery_item_text">
                                                <i class="ti-zoom-in"></i>
                                ...
                                <a href="img/enemigo3.png" class="grid-item bg_img img-gal" style="background-image: url('img/enemigo3.png')">
                                    <div class="single_gallery_item">
                                        <div class="single_gallery_item_iner">
                                            <div class="gallery_item_text">
                                                <i class="ti-zoom-in"></i>
                        ...
                        <div class="col-lg-8">
                            <div class="copyright_text">
                                <P><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                    ...
                                    Pagina diseñada por los estudiantes de 5°10
